...
import blogPosts
  from '../../../.docusaurus/docusaurus-plugin-content-blog/developers-blog/blog-post-list-prop-developers-blog.json';
    ...
    <Layout title={`Jellyfin developers`}>
      ...
      <main>
        <section className="container">
          <div className="row">
            <NavigationLinks title="Documentation" pages={[
            ...
            <NavigationLinks title={blogPosts.title} pages={blogPosts.items.slice(0, 5).map((item) => {
              return { url: item.permalink, name: item.title };
            })} />

            <NavigationLinks title="More resources" pages={[
