...
const thirdPartyClients: Array<Client> = [
  ...
  },
  {
    ...
    description:
      "A modern streamlined music player for desktop with a minimal interface that is packed with features!",
    clientType: ClientType.ThirdParty,
    deviceTypes: [DeviceType.Desktop],
    licenseType: LicenseType.OpenSource,
    platforms: [Platform.Linux, Platform.MacOS, Platform.Windows],
    primaryLinks: [
      ...
      },
      {
        ...
        name: "Installation Guide",
        url:
          "https://github.com/Taiko2k/TauonMusicBox#download-and-install-dizzy",
      },
    ],
    secondaryLinks: [
      {
    ...
    primaryLinks: [
      {
        ...
        name: "Installation Guide",
        url:
          "https://github.com/manuel-rw/jellyfin-discord-music-bot/wiki/%F0%9F%9A%80-Initial-Discord-Bot-Creation-Guide",
      },
    ],
    secondaryLinks: [
      {
  ...
  },
  {
    ...
    name: "Finer",
    description:
      "Jellyfin Music Player for macOS/iPadOS/iOS, built with native technologies.",
    clientType: ClientType.ThirdParty,
    deviceTypes: [DeviceType.Mobile],
    licenseType: LicenseType.Proprietary,
    ...
    primaryLinks: [
      {
        ...
        name: "Play Store",
        url:
          "https://play.google.com/store/apps/details?id=com.fredrikburmester.streamyfin",
      },
      {
        id: "app-store",
        name: "App Store",
  ...
  },
  {
    ...
    name: "Jellify",
    description:
      "A free and open source music player available for iOS and Android",
    clientType: ClientType.ThirdParty,
    deviceTypes: [DeviceType.Mobile],
    licenseType: LicenseType.OpenSource,
