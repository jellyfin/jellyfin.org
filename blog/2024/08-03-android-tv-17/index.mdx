...
Audio normalization support was added to automatically adjust volume levels. This feature prevents sudden volume changes between songs. To
activate this feature, you'll need to enable the LUFS scan for your music library.
...
Series and seasons now display their respective specials, which were previously available only for movies. Additionally, the search
