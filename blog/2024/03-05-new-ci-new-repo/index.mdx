...
4. As we approach stability, i.e. after the 3-5 weeks of frozen bug-fixing, we will make the decision to cut the actual final release. we am personally hoping to get this done during the weekend of April 27-28, but that may change depending on how things go during the freeze.
