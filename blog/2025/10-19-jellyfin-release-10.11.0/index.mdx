...
Jellyfin now actively checkes the available free space for its coniguration and data directories. If you have less than 2GB of free space in each, Jellyfin now refuses to start to prevent data corruption. Additionally, checks were implemented to prevent certain path misconfigurations that are know to cause issues.
