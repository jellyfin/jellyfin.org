...
When launching the Jellyfin app, it now presents you with the list of all public users and any other remembered users for you to login as.
...
Stop wasting time and get your media playing ASAP! Quickplay support is now across the entire app. Simply highlight an item and  press play on your remote. TV Season? Check. Playlist? Check. Your Music library for a week long rager? Ya' better believe check.
