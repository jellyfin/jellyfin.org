...
_Don't know what Jellyfin Vue is? Skip to **What's Jellyfin Vue?** section. What's below is a rather technical explanation_
...
You can still run the pre-Vue3 version (go to _Downloads & changelogs_ to know more), although it will not receive any support from us.
