...
description: Jellyfin Vue now runs on Vue 3
authors: ferferga
date: 2023-04-03
slug: vue-vue3
tags: [release, vue]
...
*Don't know about what Jellyfin Vue is? Skip to **What's Jellyfin Vue?** section. What's below is a rather technical explanation*

When we started working in this client, we used Nuxt and Vue 2, even when Vue 3 was right around the corner.
...
That include the majority of TVs, sadly. **Chrome/Edge/Firefox/Safari, both in desktop and mobile platforms are still fully compatible**.
...
![Screenshot of the new picture viewer](./vue3-homepage.png)
