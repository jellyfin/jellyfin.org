...
<div className='margin-bottom--md'>
  <a href='/downloads/' className='button button--primary margin-right--md'>
    <span>Download Jellyfin 10.5.0</span>
  </a>
  <a href='https://github.com/jellyfin/jellyfin/releases/tag/v10.5.0' className='button button--secondary'>
...
<ImgComparisonSlider className='margin-bottom--md'>
  <img slot='before' src={require('./old-home.jpg').default} alt='web client before' />
  <img slot='after' src={require('./new-home.jpg').default} alt='web client after' />
</ImgComparisonSlider>
...
<ImgComparisonSlider className='margin-bottom--md'>
  <img slot='before' src={require('./old-details.png').default} alt='design before' />
  <img slot='after' src={require('./new-details.png').default} alt='design after' />
</ImgComparisonSlider>
...
<img data-label='10.5.0' src={require('./webos-icons.png').default} alt='webOS icons' />
