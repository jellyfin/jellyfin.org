...
<div className='margin-bottom--md'>
  <a href='/downloads/' className='button button--primary margin-right--md'>
    <span>Download Jellyfin 10.6.0</span>
  </a>
  <a href='https://github.com/jellyfin/jellyfin/releases/tag/v10.6.0' className='button button--secondary'>
...
<ImgComparisonSlider className='margin-bottom--md'>
  <img slot='before' src={require('./details-10-5.png').default} alt='details before' />
  <img slot='after' src={require('./details-10-6.png').default} alt='details after' />
</ImgComparisonSlider>
...
<ImgComparisonSlider className='margin-bottom--md'>
  <img slot='before' src={require('./player-10-5.png').default} alt='music player before' />
  <img slot='after' src={require('./player-10-6.png').default} alt='music player after' />
</ImgComparisonSlider>
