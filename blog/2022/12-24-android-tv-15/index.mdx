...
Previously the app could be difficult to understand or display incorrectly. By adding RTL support, the app now displays
UI elements in the correct direction, making it more accessible and user-friendly. The app automatically switches based
