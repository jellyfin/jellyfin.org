...
<ImgComparisonSlider className='margin-bottom--md'>
  <img slot='before' src={require('./11-user-select.png').default} alt='authentication before' />
  <img slot='after' src={require('./12-user-select.png').default} alt='authentication after' />
</ImgComparisonSlider>
...
<ImgComparisonSlider className='margin-bottom--md'>
  <img slot='before' src={require('./11-home.png').default} alt='interface before' />
  <img slot='after' src={require('./12-home.png').default} alt='interface after' />
</ImgComparisonSlider>
...
<ImgComparisonSlider className='margin-bottom--md'>
  <img slot='before' src={require('./11-settings.png').default} alt='settings before' />
  <img slot='after' src={require('./12-settings.png').default} alt='settings after' />
</ImgComparisonSlider>
...
<ImgComparisonSlider className='margin-bottom--md'>
  <img slot='before' src={require('./11-browse.png').default} alt='browsing before' />
  <img slot='after' src={require('./12-browse.png').default} alt='browsing after' />
</ImgComparisonSlider>

<ImgComparisonSlider className='margin-bottom--md'>
  <img slot='before' src={require('./11-details.png').default} alt='selection details before' />
  <img slot='after' src={require('./12-details.png').default} alt='selection details after' />
</ImgComparisonSlider>
...
<ImgComparisonSlider className='margin-bottom--md'>
  <img slot='before' src={require('./11-player.png').default} alt='video player before' />
  <img slot='after' src={require('./12-player.png').default} alt='video player after' />
</ImgComparisonSlider>
