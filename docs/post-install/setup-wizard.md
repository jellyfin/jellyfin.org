...
- [Setup remote access to use Jellyfin when you are not at home](/docs/general/networking)
- [Setup hardware acceleration to improve performance and/or save power](/docs/general/administration/hardware-acceleration/)
