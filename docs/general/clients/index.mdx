...
For further explanation and details, please see [the announcement blog post](https://jellyfin.org/posts/client-inclusion-rules-update).

The final decision for inclusion is at the discretion of the Jellyfin Team, Core Team, and Project Leader.
