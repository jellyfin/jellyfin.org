...
| ------------------------------------------------------------------------------------------------------------------ | -------------- | -------------- | ------- | -------------- | -------------- | -------------- | -------------- | -------------- | ------------------------------------------------------------------------------- | ---- | ------------------------------------------------------------ |
| [MPEG-4 Part 2/SP](https://en.wikipedia.org/wiki/DivX)                                                             | ❌             | ❌             | ❌      | ❌             | ❌             | 🔶<sup>12</sup>| ❌             | ✅             | ✅                                                                              | ✅   | ✅                                                           |
| [MPEG-4 Part 2/ASP](<https://en.wikipedia.org/wiki/MPEG-4_Part_2#Advanced_Simple_Profile_(ASP)>)                   | ❌             | ❌             | ❌      | ❌             | ❌             | 🔶<sup>12</sup>| ❌             | ✅             |                                                                                 | ✅   | ✅                                                           |
...
<br />
<sup>12</sup>MPEG-4 decoding is only supported when using the libVLC player.
