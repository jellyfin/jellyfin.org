...
<br />
<sup>15</sup>Requires Firefox 134+ for Windows, 136+ for macOS, 137+ for Linux. On Windows 11 22H2+ and Windows 10 1507-1709, you can play H.265 (HEVC) video natively. Windows 10 1803+ and Windows 11 21H2 still need install additional extension from the Microsoft Store. macOS natively supported. Linux requires system ffmpeg.
