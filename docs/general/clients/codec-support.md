...
<sup>1</sup>MP3 Mono is incorrectly reported as unsupported and will transcode AAC.
<br />
...
To extract subtitles, the following commands can be used. The section `0:s:0` mean the first subtitle, so `0:s:1` would be the second subtitle.
