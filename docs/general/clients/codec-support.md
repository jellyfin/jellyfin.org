...
<br />
<sup>13</sup>Need FireFox 134 and above. (the support range is the same as Edge, That means you still need pay for and install the HEVC Video Extension from the Microsoft store on Windows 10/11 platform).
