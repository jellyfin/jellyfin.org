...
Generates thumbnail images from PDF files by rendering the first page, with configurable render resolution and padding mode.

**Links:**

- [GitHub](https://github.com/ricardo3m/Jellyfin_PDF_plugin)
