...
Automated subtitle generation for Jellyfin using local AI speech-to-text models (Whisper, Parakeet, and custom command providers). All processing happens on your server with no external API calls.

**Links:**

- [GitHub](https://github.com/GeiserX/jelly-subtitles)

#### Jelly Covers

Cover image provider that extracts covers from PDF, EPUB, and audiobook files, with online fallback via Open Library and Google Books when local extraction fails.

**Links:**

- [GitHub](https://github.com/GeiserX/jelly-covers)
