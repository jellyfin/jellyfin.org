...
Creates optional dialogue-enhanced audio tracks for movies and TV episodes. Dialogue Boost improves speech clarity, while Night Mode reduces the difference between quiet dialogue and loud music and effects. The original media is not modified, and generated tracks appear in Jellyfin's normal audio selector.

**Links:**

- [GitHub](https://github.com/gregorymcewanmarriot/jellyfin-plugin-guru-audio-enhancer)
