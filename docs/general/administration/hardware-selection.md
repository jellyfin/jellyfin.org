...
- Very old X86 CPUs: Starting with Jellyfin 10.11, X86 CPUs that support the AVX2 instruction set is a requirement.  For Intel Core, Haswell (Q2 2013) and newer support AVX2.  For Intel Atom/Pentium/Celeron, Tiger Lake (Q3 2020) and newer support AVX2.  For AMD, Excavtor (Q2 2015) and newer support AVX2.
