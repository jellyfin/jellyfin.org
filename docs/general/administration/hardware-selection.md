...
AMD graphics is not recommended for Jellyfin, this information is solely provided for reference. Further reading on supported codecs on AMD VCE: [https://en.wikipedia.org/wiki/Video_Coding_Engine](https://en.wikipedia.org/wiki/Video_Coding_Engine).
