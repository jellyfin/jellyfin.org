...
This page is for an **old** version of Traefik; it exists to be a continued guide for Traefik v2.x users. See the [update page](./traefik.md) for details on using the latest version of Traefik with Jellyfin.
